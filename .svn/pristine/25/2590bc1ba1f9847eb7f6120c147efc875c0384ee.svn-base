 ...
 * @author Br
 */
public class ConexaoMySql extends MetodosDeControler {
    ...
    private final String servidorT = getIpServidor();
    protected String servidor = getIpServidor();
//    private String servidor;

    private String nomeDoBanco = "sistec";
